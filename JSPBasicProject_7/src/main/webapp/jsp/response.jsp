	...
	<div class="row">
		...
		<table class="table">
			...
			<tr>
				...
				<td width="80%">
					<ul>
						<li>헤더정보 : 데이터가 도착하기 전에 먼저 전송하는 데이터</li>
						<li>화면이동</li>
						<li>전송형식</li>
					</ul>
				</td>
			...
			<tr>
				...
				<td width="80%">
					<ul>
						...
						<li style="color:red;">*****void sendRedirect(String url) : 화면 이동 => request가 초기화</li>
						<li>void setContentType(String mim) : 브라우저에 전송하는 형식
							text/html(HTML), text/xml(XML), text/plain(JSON)
						</li>
						<li>**void addCookie(Cookie c) : 쿠키를 브라우저로 전송시에 사용</li>
					</ul>
				</td>
			</tr>
		</table>
