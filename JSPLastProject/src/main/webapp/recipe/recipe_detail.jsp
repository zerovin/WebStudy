...
<body>
	<div class="wrapper row3">
		<main class="container clear">
	  	    ...
	  	    <table class="table">
	  	    	<tr>
	  	    		<td class="text-center" colspan="3">
	  	    			<img src="${vo.poster}" style="width:800px;height:250px;">
	  	    		</td>
	  	    	</tr>
	  	    	<tr>
	  	    		<td colspan="3" class="text-center" style="color:black"><h4>${vo.title}</h4></td>
	  	    	</tr>
	  	    	<tr>
	  	    		<td colspan="3" class="text-center">${vo.content}</td>
	  	    	</tr>
	  	    	<tr>
	  	    ...
	  	    <div style="height:5px"></div>
	  	    <table class="table">
	  	    	<caption><h4 style="color:black;">[레시피작성자]</h4></caption>	
	  	    	<tr>
	  	    		<td rowspan="2" class="text-center" width="15%">
	  	    			<img src="${vo.chef_poster}" style="width:100px;height:100px;">
	  	    		</td>
