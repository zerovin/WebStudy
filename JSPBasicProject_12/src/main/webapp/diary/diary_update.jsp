...
<%
	...
	DiaryVO vo=dao.diaryUpdateData(Integer.parseInt(no));
%>
<!DOCTYPE html>
<html>
<head>
			...
			<form method="POST" action="update_ok.jsp">
				<table class="table">
					<tbody>
						<tr>
							<td colspan="2">
								년도 : <input type="text" size="10" class="input-sm" name="year" value="<%=vo.getYear()%>">&nbsp;
								월 : <input type="text" size="10" class="input-sm" name="month" value="<%=vo.getMonth()%>">&nbsp;
								일 : <input type="text" size="10" class="input-sm" name="day" value="<%=vo.getDay()%>">
							</td>
						</tr>
						<tr>
							<th width="10%">제목</th>
