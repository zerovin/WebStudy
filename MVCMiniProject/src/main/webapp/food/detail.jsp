		    ...
		    <div class="flexslider carousel basiccarousel btmspace-80">
		      <ul class="slides">
		      	<c:forEach var="svo" items="${sList}">
			        <li>
			          <figure><img class="radius-10 btmspace-10" src="${svo.poster}" alt="${svo.name}" title="${svo.address}" style="width:320px;height:185px;">
			        ...
			        <div class="option">
			            <div>
			                <form onsubmit="searchPlaces(); return false;">
			                    <input type="text" value="${addr2} 맛집" id="keyword" size="15"> 
			                </form>
			            </div>
			        </div>
			        <hr>
