...
<script type="text/javascript">
	...
	let totalpage=0
	window.onload=()=>{
		//http://localhost/JavaScriptProject_3/js/food_find_js.do
		//get => GET, post=>POST
		axios.get("http://localhost/JavaScriptProject_3/js/food_find_js.do")
		.then((response)=>{
	...
	function detail(fno){
		axios.get("http://localhost/JavaScriptProject_3/js/food_detail_js.do",{
			params:{
				fno:fno
			}
